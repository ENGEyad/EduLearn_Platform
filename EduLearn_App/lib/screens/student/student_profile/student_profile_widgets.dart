part of 'student_profile_screen.dart';
            ...
            child: Column(
              ...
              children: [
                Container(
                  ...
                  child: Text(
                    l10n.studentProfileStudentAccount,
                    style: TextStyle(
                      fontSize: 12,
    ...
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Padding(
          ...
          child: Text(
            isDarkMode
                ? l10n.studentProfileDarkActive
                : l10n.studentProfileLightActive,
            style: TextStyle(
              color: mutedColor,
...
class _LanguageTile extends StatelessWidget {
  ...
  String _languageDisplayName(BuildContext context, String code) {
    ...
    switch (code) {
      case 'ar':
        return l10n.studentProfileArabic;
      case 'en':
      default:
        return l10n.studentProfileEnglish;
    }
  }
  ...
  Future<void> _showLanguagePicker(BuildContext context) async {
    ...
    final selectedCode = await showModalBottomSheet<String>(
      ...
      builder: (sheetContext) {
        ...
        final options = [
          ('en', l10n.studentProfileEnglish),
          ('ar', l10n.studentProfileArabic),
        ];
        ...
        return SafeArea(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                Text(
                  l10n.studentProfileChooseLanguage,
                ...
                Text(
                  l10n.studentProfileSelectLanguage,
    ...
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Padding(
          padding: const EdgeInsets.only(top: 2),
          child: Text(
            l10n.studentProfileAppLanguage,
            style: TextStyle(
              color: mutedColor,
              fontWeight: FontWeight.w600,
            ),
    ...
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Padding(
          padding: const EdgeInsets.only(top: 2),
          child: Text(
            l10n.studentProfileLogoutSubtitle,
            style: TextStyle(
              color: subtitleColor,
              fontWeight: FontWeight.w600,
            ),
...
class _LogoutHintTitle extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Text(
      l10n.studentProfileBeforeContinue,
      style: theme.textTheme.bodyMedium?.copyWith(
