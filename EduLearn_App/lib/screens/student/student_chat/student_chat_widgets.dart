part of 'student_chat_screen.dart';

class StudentChatEmptyState extends StatelessWidget {
  const StudentChatEmptyState({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                l10n.studentChatStartConversation,
...
class StudentChatLoadingSkeleton extends StatelessWidget {
  const StudentChatLoadingSkeleton({super.key});
...
class StudentChatDateChip extends StatelessWidget {
  final String label;

  const StudentChatDateChip({super.key, required this.label});
...
class StudentChatBubble extends StatelessWidget {
  final bool isMe;
  final String text;
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      if (isMe) ...[
                        ...
                        _StudentDeliveryIndicator(state: deliveryState),
                      ],
...
class _StudentDeliveryIndicator extends StatelessWidget {
  final ChatMessageDeliveryState state;

  const _StudentDeliveryIndicator({required this.state});
...
class StudentChatScrollToLatestButton extends StatelessWidget {
  final VoidCallback onTap;

  const StudentChatScrollToLatestButton({
    super.key,
    required this.onTap,
  });
...
class StudentChatInputBar extends StatelessWidget {
  final TextEditingController controller;
  final Future<void> Function({String? overrideText}) onSend;
  final ValueChanged<String> onChanged;
  final bool isSending;

  const StudentChatInputBar({
    super.key,
              ...
              child: Container(
                ...
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    hintText: l10n.studentChatWriteMessage,
