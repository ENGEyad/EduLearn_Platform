...
import '../teacher_support_center/teacher_support_center_screen.dart';

part 'teacher_profile_widgets.dart';
...
class TeacherProfileScreen extends StatelessWidget {
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 8),
                      _LogoutHint(
                        text: l10n.logoutHintSession,
                      ),
                      const SizedBox(height: 6),
                      _LogoutHint(
                        text: l10n.logoutHintLogin,
                      ),
                    ],
                  ),
                ),
  ...
  void _openHelpAndSupport(BuildContext context) {
    Navigator.of(context).push(
      MaterialPageRoute(
        builder: (_) => TeacherSupportCenterScreen(
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _SectionTitle(text: l10n.profile, color: titleColor),
          _SettingsTile(
          ...
          const SizedBox(height: 16),
          _SectionTitle(text: l10n.accountSettings, color: titleColor),
          _SettingsTile(
            icon: Icons.email_outlined,
            label: l10n.manageEmail,
            tileColor: tileColor,
            shadowColor: tileShadowColor,
            titleColor: titleColor,
            mutedColor: mutedColor,
          ...
          const SizedBox(height: 16),
          _SectionTitle(text: l10n.themeLanguage, color: titleColor),
          _ThemeTile(
          ...
          const SizedBox(height: 16),
          _SectionTitle(text: l10n.more, color: titleColor),
          _SettingsTile(
