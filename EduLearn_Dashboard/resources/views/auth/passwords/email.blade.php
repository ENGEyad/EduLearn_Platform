...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .back-to-login { margin-top: 32px; text-align: center; border-top: 1px solid var(--border); padding-top: 32px; }
        .login-link { color: var(--muted); text-decoration: none; font-weight: 600; transition: 0.2s; display: flex; align-items: center; justify-content: center; gap: 8px; }
...
<body>
    <div class="auth-card">
        ...
        <div class="auth-header">
            ...
            <p>{{ __('No worries! Enter your email address and we will send you a link to reset your password.') }}</p>
        </div>
        ...
        <form action="{{ route('password.email') }}" method="POST">
            ...
            <div class="field-group">
                ...
                <input type="email" name="email" class="field-input" placeholder="admin@school.com" value="{{ old('email') }}" required autofocus>
            </div>
