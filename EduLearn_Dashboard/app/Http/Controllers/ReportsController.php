...
class ReportsController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        // Start with a grouped query to avoid N+1 count calls
        ...
        // Database-level search to avoid in-memory filtering loop
        if ($search !== '') {
            $query->where(function ($q) use ($search) {
                // Search by class name (concatenated)
                ...
                // Or if any student in that class matches
        ...
        // Map results to ensure students_count is an integer
