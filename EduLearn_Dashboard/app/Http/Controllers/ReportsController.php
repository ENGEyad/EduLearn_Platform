...
class ReportsController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        // Optimization: Use a single grouped query to get class summaries and student counts in one go.
        // This resolves the N+1 regression where each class triggered separate count and search queries.
        $query = Student::query()
        ...
        $items = $query->orderBy('grade')->orderBy('class_section')->get()
            ->map(function ($row) {
                return [
                    ...
                    'students_count' => (int) $row->students_count, // Ensure integer type
                ];
            });
