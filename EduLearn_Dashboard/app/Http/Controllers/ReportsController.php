...
class ReportsController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        /**
         * ⚡ OPTIMIZATION:
         * Previously, this loop was fetching distinct classes and then running a count(*) query
         * and a 'where exists' query for EVERY class (N+1 problem).
         * Now we use a single query with GROUP BY and conditional counts.
         */
        $query = Student::query()
