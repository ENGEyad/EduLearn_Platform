...
class ReportsController extends Controller
{
    ...
    // ⚡ Bolt: Optimized N+1 query and in-memory filtering.
    public function list(Request $request)
    {
        ...
        // Start with a grouped query of classes and student counts
                  ...
                  ->orWhereExists(function ($sub) use ($search) {
                      $sub->select(DB::raw(1))
                          ...
                          ->where(function ($q3) use ($search) {
                              $q3->where('s2.full_name', 'like', "%{$search}%")
        ...
        // Map counts to integers as they may be strings from DB
