...
class ReportsController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        // Optimized: Single query with groupBy and count instead of N+1 counts in a loop
        ...
        if ($search !== '') {
            ...
            $query->where(function ($q) use ($search, $concat) {
                ...
                $q->whereRaw("$concat LIKE ?", ["%{$search}%"])
                    // Or search if any student in this group matches
        ...
        // Ensure counts are integers for consistency
