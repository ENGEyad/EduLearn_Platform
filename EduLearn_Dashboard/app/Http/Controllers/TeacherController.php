...
class TeacherController extends Controller
{
    ...
    {
        // ⚡ Bolt: Eager load withCount to optimize total_assigned_students calculation and avoid N+1 queries.
    ...
    public function store(Request $request)
    {
        ...
        // ⚡ Bolt: Eager load withCount for consistency and performance.
        $teacher->load([
            'assignments.subject',
            'assignments.classSection' => fn($q) => $q->withCount('students')
        ]);
